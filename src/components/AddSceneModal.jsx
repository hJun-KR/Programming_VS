...
export default function AddSceneModal({ onAdd, onClose }) {
  const [form, setForm] = useState({ title: '', description: '', image: '', keywords: '' });
  ...
  const inputCls = "w-full px-3 py-2.5 border border-[#e0ddd8] bg-[#f7f6f3] text-[#1a1a1a] text-sm placeholder-[#c6c5d4] focus:outline-none focus:border-[#1a237e] transition-colors";
  const labelCls = "block text-[10px] uppercase tracking-[0.12em] text-[#767683] mb-2";
    ...
    >
      <div className="modal-content bg-white border border-[#e0ddd8] w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#f0ede8] shrink-0">
          <h2 className="font-serif text-lg font-semibold text-[#1a1a1a]">새 장면 추가</h2>
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="예: 브라우저 주소창에 URL 입력"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="이 장면에서 무슨 일이 일어나는지 설명해 주세요."
            ...
            <div>
              <label className={labelCls}>
                <span className="flex items-center gap-1"><ImageIcon className="w-3 h-3" />이미지 URL (선택)</span>
              </label>
              <input
